...
!  Darren Evans-Young
!
!  Program: Load police1 Database 
!           
!  Input: Read in Sequential police1 File [police1.data] 
!  Output: Write to Direct police1 database [police1.db]
!---------------------------------------------------------------------------------------
  ...
  OPEN(8, fILE="police1.db", FORM="FORMATTED", ACCESS="DIRECT", RECL=111)
